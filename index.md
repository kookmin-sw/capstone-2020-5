...
<p>
  AV-Test의 통계 조사에 따르면 매일 약 350,000 개의 악성코드가 새로 생성되고 있으며, 2019년에는 매달 평균적으로 약 12,075,800 개의 악성코드가 새로 생성되었습니다.<br>
  최근 자동 분석도구가 발전하고 있으나 100%의 정확도를 갖지 않기 때문에 일부 파일에 대해서 전문가의 개입이 필수적입니다.
</p>

<img src="https://user-images.githubusercontent.com/28583588/77532079-806ef200-6ed7-11ea-84d4-808a06fb34d4.png" width="50%" height="50%">

<p>
  AhnLab에 따르면 전문가가 한개의 악성코드를 분석하는데는 최소 몇시간, 최대 몇주가 소요됩니다.<br>
...
<p>
  AV-Test's statistics show that approximately 350,000 new malicious codes are generated every day, and in 2019, an average of 12,075,800 new malicious codes are generated every month.<br>
  Experts intervention is essential for some files, as automated analysis tools have recently evolved but do not have 100% accuracy.<br>
  According to AnLab, it takes at least hours and weeks for an expert to analyze a malicious code.<br>
  However, while research on automatic analysis tools for malicious code is active, research and investment of malicious code analysis tools for experts are far from sufficient.<br>
  The goal of this project is to develop deep learning-based malware analysis aids.<br>
