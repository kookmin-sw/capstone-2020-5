            ...
            <div className="sample_container">
                ...
                <div className="sample_body">
                    ...
                    <div className="mnemonic">
                        ...
                        <div className="tab-content">
                            <div className="tab-pane tab_contents fade show active" id="qwe">
                                <p>
                                    {this.state.mnemonicIndices == null ? <br/> : this.createListOfIndices(this.state.mnemonicIndices, this.mnemonics)}
                                </p>
                            </div>
                            <div className="tab-pane tab_contents fade" id="asd">
                                <p>
                                    {this.state.stringIndices == null ? <br/> : this.createListOfIndices(this.state.stringIndices, this.string)}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="string">
                        ...
                        <ul className="nav nav-tabs data_tabs">
                            <li className="nav-item">
                                <a className="nav-link active" data-toggle="tab" href="#m1">30</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" data-toggle="tab" href="#m2">30</a>
                            </li>
                        </ul>
                        <div className="tab-content">
                            <div className="tab-pane tab_contents fade show active" id="m1">
                                <p>
                                    {this.state.stringIndices == null ? <br/> : this.createListOfIndices(this.state.stringIndices, this.string)}

                                </p>
                            </div>
                            <div className="tab-pane tab_contents fade" id="m2">
                                <p>
                                    add<br></br>
                                    add<br></br>
                                    add<br></br>
...
>>>>>>> d95f68c7011b02ace4944c2477786a52a5b8121b
            <br/>
